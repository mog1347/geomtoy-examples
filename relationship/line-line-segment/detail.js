...
import { j as Relationship, U as Utility, l as Line, L as LineSegment, B as Bezier } from '../../js/geomtoy.js';
...
tpl.title("Line-line segment relationship");
...
}
{
  tpl.addSection("Separate");
  {
    ...
    const lineSegment = new LineSegment([20, 30], [0, 0]);
    trileanResult(card, line, lineSegment, rs.separate(line, lineSegment));
  }
}
{
